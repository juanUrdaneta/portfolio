 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/let x0=typeof window<"u"?So.useLayoutEffect:So.useEffect,y0=n=>n&&!Array.isArray(n)&&typeof n=="object",oc=[],pA={},yM=ct;const Fs=(n,e=oc)=>{let t=pA;y0(n)?(t=n,n=null,e="dependencies"in t?t.dependencies:oc):y0(e)&&(t=e,e="dependencies"in t?t.dependencies:oc);let{scope:i,revertOnUpdate:r}=t,[s,o]=So.useState(!1);n&&typeof n!="function"&&console.warn("First parameter must be a function or config object");const a=yM.context(()=>{},i),l=d=>a.add(null,d),u=()=>a.revert(),c=e&&e.length&&!r;return x0(()=>{if(n&&a.add(n,i),!c||!s)return u},e),c&&x0(()=>(o(!0),u),oc),{context:a,contextSafe:l}};Fs.register=n=>{yM=n};Fs.headless=!0;const mA=()=>(Fs(()=>{ct.to("#header-content",{y:"80vh",opacity:.4,scale:.9,ease:"linear",scrollTrigger:{trigger:"#header",start:"top top",scrub:!0}})},[]),J.jsx("div",{id:"header",className:"relative w-screen h-screen max-h-[1600px] flex flex-col justify-start overflow-hidden z-10  bg-black-soft max-[1600px]:px-8",children:J.jsxs("div",{id:"header-content",className:"w-full h-full flex justify-center items-center flex-col",children:[J.jsx("section",{className:"w-full flex flex-col md:flex-row justify-center md:items-center ",children:J.jsx("div",{className:"w-full",id:"name-box",children:J.jsx("p",{className:"text-white-bone text-xl md:text-center md:text-lg font-inter font-thin select-none mt-56 ",children:"Software Engineer and creative developer"})})}),J.jsx("div",{className:"w-full max-w-[1600px] ",children:J.jsx("h2",{className:"text-white-bone  font-interText font-bold  mb-4 text-md uppercase",children:"My recent Projects"})}),J.jsxs("section",{id:"cta",className:"flex flex-grow w-full max-w-[1600px] justify-center pb-2 gap-5",children:[J.jsx(ch,{name:"Shortbread AI",pic:"shortbread.jpeg"}),J.jsx(ch,{name:"Climatika",pic:"climatika.png",cn:"hidden min-[800px]:flex"}),J.jsx(ch,{name:"Dvinum",pic:"dvinum.jpeg",cn:"hidden min-[1000px]:flex"})]}),J.jsx("div",{className:"flex justify-center items-start h-16 ",children:J.jsx("a",{href:"mailto:urdntjuan@gmail.com",children:J.jsx("button",{className:"w-64 h-12 text-black-soft transition-all duration-500 rounded-xl bg-white-bone hover:bg-white-bone/80 ",children:"Let's work together!"})})})]})})),ch=({name:n,pic:e,cn:t})=>{const[i,r]=Fa.useState(!1);return J.jsxs("div",{className:`relative h-full w-full flex flex-col ${t}`,children:[J.jsx("div",{onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),className:"relative  h-full max-w-full rounded-lg  overflow-hidden ",children:J.jsx("img",{src:e,alt:n,className:`w-full h-full object-cover ${i?"grayscale-0 scale-105":"grayscale-0 "} transition-all duration-300`})}),J.jsx("p",{className:"text-white-bone w-full h-22 font-inter   font-semibold uppercase text-center py-4",children:n})]})};function S0(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function gA(n,e,t){return e&&S0(n.prototype,e),t&&S0(n,t),n}/*!
 * Observer 3.12.5
 * https://gsap.com
 *
 * @license Copyright 2008-2024, GreenSock. All rights reserved.
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var dn,of,fi,cs,fs,La,SM,Zs,$l,MM,Dr,Hi,EM,TM=function(){return dn||typeof window<"u"&&(dn=window.gsap)&&dn.registerPlugin&&dn},wM=1,ya=[],nt=[],mr=[],ql=Date.now,sm=function(e,t){return t},_A=function(){var e=$l.core,t=e.bridge||{},i=e._scrollers,r=e._proxies;i.push.apply(i,nt),r.push.apply(r,mr),nt=i,mr=r,sm=function(o,a){return t[o](a)}},Es=function(e,t){return~mr.indexOf(e)&&mr[mr.indexOf(e)+1][t]},Kl=function(e){return!!~MM.indexOf(e)},Ln=function(e,t,i,r,s){return e.addEventListener(t,i,{passive:r!==!1,capture:!!s})},bn=function(e,t,i,r){return e.removeEventListener(t,i,!!r)},ac="scrollLeft",lc="scrollTop",om=function(){return Dr&&Dr.isPressed||nt.cache++},Wf=function(e,t){var i=function r(s){if(s||s===0){wM&&(fi.history.scrollRestoration="manual");var o=Dr&&Dr.isPressed;s=r.v=Math.round(s)||(Dr&&Dr.iOS?1:0),e(s),r.cacheID=nt.cache,o&&sm("ss",s)}else(t||nt.cache!==r.cacheID||sm("ref"))&&(r.cacheID=nt.cache,r.v=e());return r.v+r.offset};return i.offset=0,e&&i},kn={s:ac,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Wf(function(n){return arguments.length?fi.scrollTo(n,Zt.sc()):fi.pageXOffset||cs[ac]||fs[ac]||La[ac]||0})},Zt={s:lc,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:kn,sc:Wf(function(n){return arguments.length?fi.scrollTo(kn.sc(),n):fi.pageYOffset||cs[lc]||fs[lc]||La[lc]||0})},Wn=function(e,t){return(t&&t._ctx&&t._ctx.selector||dn.utils.toArray)(e)[0]||(typeof e=="string"&&dn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},bs=function(e,t){var i=t.s,r=t.sc;Kl(e)&&(e=cs.scrollingElement||fs);var s=nt.indexOf(e),o=r===Zt.sc?1:2;!~s&&(s=nt.push(e)-1),nt[s+o]||Ln(e,"scroll",om);var a=nt[s+o],l=a||(nt[s+o]=Wf(Es(e,i),!0)||(Kl(e)?r:Wf(function(u){return arguments.length?e[i]=u:e[i]})));return l.target=e,a||(l.smooth=dn.getProperty(e,"scrollBehavior")==="smooth"),l},am=function(e,t,i){var r=e,s=e,o=ql(),a=o,l=t||50,u=Math.max(500,l*3),c=function(_,g){var m=ql();g||m-o>l?(s=r,r=_,a=o,o=m):i?r+=_:r=s+(_-s)/(m-a)*(o-a)},d=function(){s=r=i?0:r,a=o=0},f=function(_){var g=a,m=s,h=ql();return(_||_===0)&&_!==r&&c(_),o===a||h-a>u?0:(r+(i?m:-m))/((i?h:o)-g)*1e3};return{update:c,reset:d,getVelocity:f}},_l=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},M0=function(e){var t=Math.max.apply(Math,e),i=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(i)?t:i},AM=function(){$l=dn.core.globals().ScrollTrigger,$l&&$l.core&&_A()},CM=function(e){return dn=e||TM(),!of&&dn&&typeof document<"u"&&document.body&&(fi=window,cs=document,fs=cs.documentElement,La=cs.body,MM=[fi,cs,fs,La],dn.utils.clamp,EM=dn.core.context||function(){},Zs="onpointerenter"in La?"pointer":"mouse",SM=Gt.isTouch=fi.matchMedia&&fi.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in fi||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Hi=Gt.eventTypes=("ontouchstart"in fs?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in fs?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return wM=0},500),AM(),of=1),of};kn.op=Zt;nt.cache=0;var Gt=function(){function n(t){this.init(t)}var e=n.prototype;return e.init=function(i){of||CM(dn)||console.warn("Please gsap.registerPlugin(Observer)"),$l||AM();var r=i.tolerance,s=i.dragMinimum,o=i.type,a=i.target,l=i.lineHeight,u=i.debounce,c=i.preventDefault,d=i.onStop,f=i.onStopDelay,p=i.ignore,_=i.wheelSpeed,g=i.event,m=i.onDragStart,h=i.onDragEnd,v=i.onDrag,x=i.onPress,S=i.onRelease,C=i.onRight,T=i.onLeft,E=i.onUp,P=i.onDown,M=i.onChangeX,y=i.onChangeY,N=i.onChange,U=i.onToggleX,D=i.onToggleY,X=i.onHover,j=i.onHoverEnd,K=i.onMove,Y=i.ignoreCheck,L=i.isNormalizer,G=i.onGestureStart,R=i.onGestureEnd,ie=i.onWheel,te=i.onEnable,Fe=i.onDisable,H=i.onClick,ee=i.scrollSpeed,le=i.capture,ne=i.allowClicks,Ue=i.lockAxis,Ie=i.onLockAxis;this.target=a=Wn(a)||fs,this.vars=i,p&&(p=dn.utils.toArray(p)),r=r||1e-9,s=s||0,_=_||1,ee=ee||1,o=o||"wheel,touch,pointer",u=u!==!1,l||(l=parseFloat(fi.getComputedStyle(La).lineHeight)||22);var k,We,Me,Ce,ve,Re,Le,F=this,qe=0,b=0,w=i.passive||!c,W=bs(a,kn),Q=bs(a,Zt),re=W(),se=Q(),xe=~o.indexOf("touch")&&!~o.indexOf("pointer")&&Hi[0]==="pointerdown",de=Kl(a),oe=a.ownerDocument||cs,ke=[0,0,0],ue=[0,0,0],Ae=0,Qe=function(){return Ae=ql()},ye=function(Te,at){return(F.event=Te)&&p&&~p.indexOf(Te.target)||at&&xe&&Te.pointerType!=="touch"||Y&&Y(Te,at)},Se=function(){F._vx.reset(),F._vy.reset(),We.pause(),d&&d(F)},ze=function(){var Te=F.deltaX=M0(ke),at=F.deltaY=M0(ue),pe=Math.abs(Te)>=r,Xe=Math.abs(at)>=r;N&&(pe||Xe)&&N(F,Te,at,ke,ue),pe&&(C&&F.deltaX>0&&C(F),T&&F.deltaX<0&&T(F),M&&M(F),U&&F.deltaX<0!=qe<0&&U(F),qe=F.deltaX,ke[0]=ke[1]=ke[2]=0),Xe&&(P&&F.deltaY>0&&P(F),E&&F.deltaY<0&&E(F),y&&y(F),D&&F.deltaY<0!=b<0&&D(F),b=F.deltaY,ue[0]=ue[1]=ue[2]=0),(Ce||Me)&&(K&&K(F),Me&&(v(F),Me=!1),Ce=!1),Re&&!(Re=!1)&&Ie&&Ie(F),ve&&(ie(F),ve=!1),k=0},Ye=function(Te,at,pe){ke[pe]+=Te,ue[pe]+=at,F._vx.update(Te),F._vy.update(at),u?k||(k=requestAnimationFrame(ze)):ze()},_t=function(Te,at){Ue&&!Le&&(F.axis=Le=Math.abs(Te)>Math.abs(at)?"x":"y",Re=!0),Le!=="y"&&(ke[2]+=Te,F._vx.update(Te,!0)),Le!=="x"&&(ue[2]+=at,F._vy.update(at,!0)),u?k||(k=requestAnimationFrame(ze)):ze()},Be=function(Te){if(!ye(Te,1)){Te=_l(Te,c);var at=Te.clientX,pe=Te.clientY,Xe=at-F.x,De=pe-F.y,Ge=F.isDragging;F.x=at,F.y=pe,(Ge||Math.abs(F.startX-at)>=s||Math.abs(F.startY-pe)>=s)&&(v&&(Me=!0),Ge||(F.isDragging=!0),_t(Xe,De),Ge||m&&m(F))}},I=F.onPress=function(Oe){ye(Oe,1)||Oe&&Oe.button||(F.axis=Le=null,We.pause(),F.isPressed=!0,Oe=_l(Oe),qe=b=0,F.startX=F.x=Oe.clientX,F.startY=F.y=Oe.clientY,F._vx.reset(),F._vy.reset(),Ln(L?a:oe,Hi[1],Be,w,!0),F.deltaX=F.deltaY=0,x&&x(F))},$=F.onRelease=function(Oe){if(!ye(Oe,1)){bn(L?a:oe,Hi[1],Be,!0);var Te=!isNaN(F.y-F.startY),at=F.isDragging,pe=at&&(Math.abs(F.x-F.startX)>3||Math.abs(F.y-F.startY)>3),Xe=_l(Oe);!pe&&Te&&(F._vx.reset(),F._vy.reset(),c&&ne&&dn.delayedCall(.08,function(){if(ql()-Ae>300&&!Oe.defaultPrevented){if(Oe.target.click)Oe.target.click();else if(oe.createEvent){var De=oe.createEvent("MouseEvents");De.initMouseEvent("click",!0,!0,fi,1,Xe.screenX,Xe.screenY,Xe.clientX,Xe.clientY,!1,!1,!1,!1,0,null),Oe.target.dispatchEvent(De)}}})),F.isDragging=F.isGesturing=F.isPressed=!1,d&&at&&!L&&We.restart(!0),h&&at&&h(F),S&&S(F,pe)}},Z=function(Te){return Te.touches&&Te.touches.length>1&&(F.isGesturing=!0)&&G(Te,F.isDragging)},fe=function(){return(F.isGesturing=!1)||R(F)},he=function(Te){if(!ye(Te)){var at=W(),pe=Q();Ye((at-re)*ee,(pe-se)*ee,1),re=at,se=pe,d&&We.restart(!0)}},je=function(Te){if(!ye(Te)){Te=_l(Te,c),ie&&(ve=!0);var at=(Te.deltaMode===1?l:Te.deltaMode===2?fi.innerHeight:1)*_;Ye(Te.deltaX*at,Te.deltaY*at,0),d&&!L&&We.restart(!0)}},lt=function(Te){if(!ye(Te)){var at=Te.clientX,pe=Te.clientY,Xe=at-F.x,De=pe-F.y;F.x=at,F.y=pe,Ce=!0,d&&We.restart(!0),(Xe||De)&&_t(Xe,De)}},mt=function(Te){F.event=Te,X(F)},yt=function(Te){F.event=Te,j(F)},rt=function(Te){return ye(Te)||_l(Te,c)&&H(F)};We=F._dc=dn.delayedCall(f||.25,Se).pause(),F.deltaX=F.deltaY=0,F._vx=am(0,50,!0),F._vy=am(0,50,!0),F.scrollX=W,F.scrollY=Q,F.isDragging=F.isGesturing=F.isPressed=!1,EM(this),F.enable=function(Oe){return F.isEnabled||(Ln(de?oe:a,"scroll",om),o.indexOf("scroll")>=0&&Ln(de?oe:a,"scroll",he,w,le),o.indexOf("wheel")>=0&&Ln(a,"wheel",je,w,le),(o.indexOf("touch")>=0&&SM||o.indexOf("pointer")>=0)&&(Ln(a,Hi[0],I,w,le),Ln(oe,Hi[2],$),Ln(oe,Hi[3],$),ne&&Ln(a,"click",Qe,!0,!0),H&&Ln(a,"click",rt),G&&Ln(oe,"gesturestart",Z),R&&Ln(oe,"gestureend",fe),X&&Ln(a,Zs+"enter",mt),j&&Ln(a,Zs+"leave",yt),K&&Ln(a,Zs+"move",lt)),F.isEnabled=!0,Oe&&Oe.type&&I(Oe),te&&te(F)),F},F.disable=function(){F.isEnabled&&(ya.filter(function(Oe){return Oe!==F&&Kl(Oe.target)}).length||bn(de?oe:a,"scroll",om),F.isPressed&&(F._vx.reset(),F._vy.reset(),bn(L?a:oe,Hi[1],Be,!0)),bn(de?oe:a,"scroll",he,le),bn(a,"wheel",je,le),bn(a,Hi[0],I,le),bn(oe,Hi[2],$),bn(oe,Hi[3],$),bn(a,"click",Qe,!0),bn(a,"click",rt),bn(oe,"gesturestart",Z),bn(oe,"gestureend",fe),bn(a,Zs+"enter",mt),bn(a,Zs+"leave",yt),bn(a,Zs+"move",lt),F.isEnabled=F.isPressed=F.isDragging=!1,Fe&&Fe(F))},F.kill=F.revert=function(){F.disable();var Oe=ya.indexOf(F);Oe>=0&&ya.splice(Oe,1),Dr===F&&(Dr=0)},ya.push(F),L&&Kl(a)&&(Dr=F),F.enable(g)},gA(n,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),n}();Gt.version="3.12.5";Gt.create=function(n){return new Gt(n)};Gt.register=CM;Gt.getAll=function(){return ya.slice()};Gt.getById=function(n){return ya.filter(function(e){return e.vars.id===n})[0]};TM()&&dn.registerPlugin(Gt);/*!
...
#define LOW_PRECISION`),e}function vL(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===$M?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===HA?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Tr&&(e="SHADOWMAP_TYPE_VSM"),e}function xL(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Za:case Qa:e="ENVMAP_TYPE_CUBE";break;case Sd:e="ENVMAP_TYPE_CUBE_UV";break}return e}function yL(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Qa:e="ENVMAP_MODE_REFRACTION";break}return e}function SL(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case qM:e="ENVMAP_BLENDING_MULTIPLY";break;case hC:e="ENVMAP_BLENDING_MIX";break;case pC:e="ENVMAP_BLENDING_ADD";break}return e}function ML(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function EL(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=vL(t),u=xL(t),c=yL(t),d=SL(t),f=ML(t),p=cL(t),_=fL(s),g=r.createProgram();let m,h,v=t.glslVersion?"#version "+t.glslVersion+`
...
}`;const iu={x:"#DFDEDE",y:"#8B9357",z:"#2B352E"},sD=()=>{const n=Fa.useRef(null);return Fs(()=>{if(n.current){const e={width:window.innerWidth,height:window.innerHeight},t=new tD,i=window.innerWidth/window.innerHeight,r=new v1(-i,i,1,-1,0,1);r.position.z=1,t.add(r);const s=new tl(2*i,2,32,32),o=new Gr({vertexShader:iD,fragmentShader:rD,side:or});o.uniforms={uTime:{value:0},uScrollPos:{value:0},uColor:{value:[new dt(iu.x),new dt(iu.y),new dt(iu.z)]}};const a=new fr(s,o);t.add(a);const l=new eD({canvas:n.current});l.setSize(e.width,e.height),l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.setSize(window.innerWidth,window.innerHeight);const u=new nD,c=()=>{window.requestAnimationFrame(()=>{const d=u.getElapsedTime();o.uniforms.uTime.value=d,l.render(t,r)})};c(),ct.to("#main-box",{scrollTrigger:{trigger:"#main-box",start:"top top",end:"bottom bottom",onUpdate:d=>{const f=d.progress.toFixed(3);o.uniforms.uScrollPos.value=f,c()},scrub:!0,markers:!1}}),window.addEventListener("resize",()=>{e.width=window.innerWidth,e.height=window.innerHeight;const d=window.innerWidth,f=window.innerHeight,p=d/f;r.left=-p,r.right=p,r.top=1,r.bottom=-1,r.updateProjectionMatrix(),r.updateProjectionMatrix(),a.geometry.dispose(),a.geometry=new tl(2*p,2,32,32),l.setSize(d,f),l.setPixelRatio(Math.min(window.devicePixelRatio,2)),c()})}},[]),J.jsx("div",{className:"sticky top-0 z-0 w-screen h-0 bg-transparent  ",children:J.jsx("canvas",{style:{width:"100%",height:"100%"},ref:n})})},oD=So.createContext({activeColor:iu,setColor:()=>console.error("NOT IMPLEMENTED")}),aD=()=>(Fs(()=>{ct.to("#about-me-one",{opacity:1,ease:"sine.out",duration:.8,scrollTrigger:{trigger:"#name-box",start:"top top"}}),ct.to("#about-me-two",{opacity:1,ease:"sine.out",duration:.8,scrollTrigger:{trigger:"#name-box",start:"top top"}}),ct.to("#about-me-one",{y:0,ease:"power4.out",duration:1.2,scrollTrigger:{trigger:"#name-box",start:"top top"}}),ct.to("#about-me-two",{y:0,ease:"power4.out",duration:1.2,scrollTrigger:{trigger:"#name-box",start:"top top"}})},[]),J.jsx("div",{className:" relative h-[90vh] max-h-[1400px] w-screen flex",children:J.jsx("div",{className:"w-full flex",children:J.jsx("div",{id:"about-me-one",className:"w-full h-full flex justify-center translate-y-[25vh] opacity-0  ",children:J.jsxs("div",{className:"w-7/12 h-full flex flex-col justify-center items-center px-12 ",children:[J.jsx("h3",{className:"text-3xl md:text-5xl font-inter font-extrabold mb-10",children:"Hi there!"}),J.jsxs("p",{className:"text-2xl md:text-4xl text-center font-inter font-thin mb-16",children:[J.jsx("span",{className:"fo nt-bold",children:"Pixel perfect"})," software engineer based in Buenos Aires."]}),J.jsx("p",{className:"text-2xl md:text-4xl text-center font-inter font-thin mb-16",children:"Experienced in React, Next.js, AWS and a bunch of cool tech."}),J.jsx("p",{className:"text-2xl md:text-4xl text-center font-inter font-thin mb-16",children:"Passionate about turning great ideas into great products."}),J.jsx("p",{className:"text-2xl md:text-4xl text-center font-inter font-thin mb-16",children:"Problem-solving oriented, naturally curious, continually growing."})]})})})})),lD=()=>(Fs(()=>{ct.fromTo("#header-nav-name",{y:"7rem"},{y:0,fontSize:"2rem",scrollTrigger:{trigger:"#header",start:"top top",scrub:!0,onUpdate:n=>{n.progress>.9?(ct.to("#header-career",{color:"#141516"}),ct.to("#header-email",{color:"#141516"}),ct.to("#header-nav-name",{color:"#141516"}),ct.to("#navbar",{backgroundColor:"rgba(249,246,238,0.6)"})):(ct.to("#header-career",{color:"#f9f6ee"}),ct.to("#header-email",{color:"#f9f6ee"}),ct.to("#header-nav-name",{color:"#f9f6ee"}),ct.to("#navbar",{backgroundColor:"#141516"}))}}})},[]),J.jsx("div",{id:"navbar",className:"w-screen h-20 fixed top-0 z-50 mt-[-1px] flex justify-center backdrop-blur-md max-[1600px]:px-8 ",children:J.jsxs("nav",{className:"relative flex flex-row-reverse justify-between items-center w-[1600px] max-w-screen",children:[J.jsx("p",{id:"header-email",className:"font-interText text-white-bone hidden md:flex ",children:J.jsx("a",{className:"decoration",href:"mailto:urdntjuan@gmail.com",children:"urdntjuan@gmail.com"})}),J.jsx("p",{id:"header-nav-name",className:"absolute w-full font-interText font-extrabold max-[930px]:text-7xl max-[1210px]:text-8xl text-9xl tracking-wide uppercase select-none text-white-bone text-left md:text-center ",children:"Juan Urdaneta"}),J.jsx("p",{id:"header-career",className:"uppercase font-interText text-white-bone hidden min-[1100px]:flex",children:"Software engineer / Creative Developer"})]})}));ct.registerPlugin(Je);function uD(){const[n,e]=Fa.useState(iu);return Fa.useEffect(()=>{const t=new kA({lerp:.1});t.on("scroll",Je.update),ct.ticker.add(i=>{t.raf(i*1e3)}),ct.ticker.lagSmoothing(0)},[]),Fs(()=>{ct.to("#box-effect",{bottom:"100vh",ease:"power4.inOut",duration:2.5,delay:.5,onComplete:()=>{ct.to("#box-effect",{opacity:0,visibility:"hidden"})}}),ct.fromTo("#name-box",{opacity:0},{opacity:1,delay:.6,duration:2,ease:"sine.out"})},[]),J.jsx(J.Fragment,{children:J.jsx(oD.Provider,{value:{activeColor:n,setColor:e},children:J.jsxs("main",{id:"main-box",className:"relative",children:[J.jsx(lD,{}),J.jsx(sD,{}),J.jsx(mA,{}),J.jsx(aD,{}),J.jsx(NA,{}),J.jsx("div",{className:" relative w-full h-72 backdrop-invert bg-[#949596]/20"}),J.jsx(UA,{})]})})})}Zh.createRoot(document.getElementById("root")).render(J.jsx(Fa.StrictMode,{children:J.jsx(uD,{})}));
