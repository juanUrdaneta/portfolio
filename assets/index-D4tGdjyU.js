...
`)+`
`+h);const x=v+m+o,S=v+h+a,C=Qv(r,r.VERTEX_SHADER,x),T=Qv(r,r.FRAGMENT_SHADER,S);r.attachShader(g,C),r.attachShader(g,T),t.index0AttributeName!==void 0?r.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function E(N){if(n.debug.checkShaderErrors){const I=r.getProgramInfoLog(g).trim(),D=r.getShaderInfoLog(C).trim(),X=r.getShaderInfoLog(T).trim();let j=!0,K=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(j=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,g,C,T);else{const Y=Jv(r,C,"vertex"),L=Jv(r,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
...
}`;const iu={x:"#DFDEDE",y:"#8B9357",z:"#2B352E"},oD=()=>{const n=co.useRef(null);return Xr(()=>{if(n.current){const e={width:window.innerWidth,height:window.innerHeight},t=new nD,i=window.innerWidth/window.innerHeight,r=new v1(-i,i,1,-1,0,1);r.position.z=1,t.add(r);const s=new tl(2*i,2,32,32),o=new Gr({vertexShader:rD,fragmentShader:sD,side:or});o.uniforms={uTime:{value:0},uScrollPos:{value:0},uColor:{value:[new ft(iu.x),new ft(iu.y),new ft(iu.z)]}};const a=new fr(s,o);t.add(a);const l=new tD({canvas:n.current});l.setSize(e.width,e.height),l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.setSize(window.innerWidth,window.innerHeight);const u=new iD,c=()=>{window.requestAnimationFrame(()=>{const d=u.getElapsedTime();o.uniforms.uTime.value=d,l.render(t,r)})};c(),At.to("#main-box",{scrollTrigger:{trigger:"#main-box",start:"top top",end:"bottom bottom",onUpdate:d=>{const f=d.progress.toFixed(3);o.uniforms.uScrollPos.value=f,c()},scrub:!0,markers:!1}}),window.addEventListener("resize",()=>{e.width=window.innerWidth,e.height=window.innerHeight;const d=window.innerWidth,f=window.innerHeight,p=d/f;r.left=-p,r.right=p,r.top=1,r.bottom=-1,r.updateProjectionMatrix(),r.updateProjectionMatrix(),a.geometry.dispose(),a.geometry=new tl(2*p,2,32,32),l.setSize(d,f),l.setPixelRatio(Math.min(window.devicePixelRatio,2)),c()})}},[]),J.jsx("div",{className:"sticky top-0 z-0 hidden md:flex w-screen h-0 bg-transparent  ",children:J.jsx("canvas",{style:{width:"100%",height:"100%"},ref:n})})},aD=Mo.createContext({activeColor:iu,setColor:()=>console.error("NOT IMPLEMENTED")}),lD=()=>(Xr(()=>{At.to("#about-me-one",{opacity:1,ease:"sine.out",duration:.8,scrollTrigger:{trigger:"#header",start:"bottom center"}}),At.to("#about-me-one",{y:0,ease:"power4.out",duration:1.2,scrollTrigger:{trigger:"#header",start:"bottom center"}})},[]),J.jsx("div",{className:" relative h-[70vh] md:h-[90vh] max-h-[1400px] w-screen flex",children:J.jsx("div",{className:"w-full flex",children:J.jsx("div",{id:"about-me-one",className:"w-full h-full flex justify-center translate-y-[25vh] opacity-0  ",children:J.jsxs("div",{className:"w-full md:w-7/12 h-full flex flex-col justify-center items-center px-12 ",children:[J.jsx("h3",{className:"text-lg md:text-5xl font-inter font-extrabold mb-10",children:"Hi there!"}),J.jsxs("p",{className:"text-md md:text-4xl text-center font-inter font-light mb-8 md:mb-16",children:[J.jsx("span",{className:"font-bold",children:"Pixel perfect"})," software engineer based in Buenos Aires."]}),J.jsx("p",{className:"text-md md:text-4xl text-center font-inter font-light mb-8 md:mb-16",children:"Experienced in React, Next.js, AWS and a bunch of cool tech."}),J.jsx("p",{className:"text-md md:text-4xl text-center font-inter font-light mb-8 md:mb-16",children:"Passionate about turning great ideas into great products."}),J.jsx("p",{className:"text-md md:text-4xl text-center font-inter font-light mb-8 md:mb-16",children:"Problem-solving oriented, naturally curious, continually growing."})]})})})})),uD=()=>(Xr(()=>{At.fromTo("#header-nav-name",{y:"7rem"},{y:0,fontSize:"2rem",scrollTrigger:{trigger:"#header",start:"top top",scrub:!0,onUpdate:n=>{n.progress>.9?(At.to("#header-career",{color:"#141516"}),At.to("#header-email",{color:"#141516"}),At.to("#header-nav-name",{color:"#141516"}),At.to("#navbar",{backgroundColor:"rgba(249,246,238,0.6)"})):(At.to("#header-career",{color:"#f9f6ee"}),At.to("#header-email",{color:"#f9f6ee"}),At.to("#header-nav-name",{color:"#f9f6ee"}),At.to("#navbar",{backgroundColor:"#141516"}))}}})},[]),J.jsx("div",{id:"navbar",className:"w-screen h-20 fixed top-0 z-50 mt-[-1px] flex justify-center backdrop-blur-md max-[1600px]:px-8 ",children:J.jsxs("nav",{className:"relative flex flex-row-reverse justify-between items-center w-[1600px] max-w-screen",children:[J.jsx("p",{id:"header-email",className:"font-interText text-white-bone hidden md:flex ",children:J.jsx("a",{className:"decoration",href:"mailto:urdntjuan@gmail.com",children:"urdntjuan@gmail.com"})}),J.jsx("p",{id:"header-nav-name",className:"absolute w-full font-interText font-extrabold text-5xl min-[600px]:text-7xl min-[930px]:text-8xl min-[1210px]:text-9xl tracking-wide uppercase select-none text-white-bone text-left md:text-center ",children:"Juan Urdaneta"}),J.jsx("p",{id:"header-career",className:"uppercase font-interText text-white-bone hidden min-[1100px]:flex",children:"Software engineer / Creative Developer"})]})}));At.registerPlugin(nt);function cD(){const[n,e]=co.useState(iu),[t,i]=co.useState(null);return co.useEffect(()=>{const r=new zA({lerp:.1});r.on("scroll",nt.update),i(r),At.ticker.add(s=>{r.raf(s*1e3)}),At.ticker.lagSmoothing(0)},[]),Xr(()=>{At.to("#box-effect",{bottom:"100vh",ease:"power4.inOut",duration:2.5,delay:.5,onComplete:()=>{At.to("#box-effect",{opacity:0,visibility:"hidden"})}})},[]),J.jsx(J.Fragment,{children:J.jsx(aD.Provider,{value:{activeColor:n,setColor:e},children:J.jsxs("main",{id:"main-box",className:"relative",children:[J.jsx(uD,{}),J.jsx(oD,{}),J.jsx(mA,{scrollTo:r=>{t==null||t.scrollTo(r,{offset:-200})}}),J.jsx(lD,{}),J.jsx(_A,{}),J.jsx("div",{className:" relative w-full h-72 backdrop-invert bg-[#949596]/20"}),J.jsx(vA,{})]})})})}Zh.createRoot(document.getElementById("root")).render(J.jsx(co.StrictMode,{children:J.jsx(cD,{})}));
