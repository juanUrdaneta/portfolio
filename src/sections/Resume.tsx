  ...
  return (
    <div id="resume" className="relative w-screen z-30 flex justify-center ">
      <div className="w-4/6 max-w-[1600px] flex flex-col h-full ">
        <div className="w-full z-10 h-[800px] flex items-center mb-24 ">
          <p className="w-1/2 text-2xl leading-10 text-left font-inter font-thin">
        ...
        <div className="w-full h-full flex justify-start items-center gap-12 mb-24 ">
          ...
          <div className="w-1/2 flex flex-col ">
            <p className="text-xl text-left font-inter font-thin mb-12">
