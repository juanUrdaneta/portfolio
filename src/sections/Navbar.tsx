  ...
  return (
    ...
    >
      <nav className="relative flex flex-row-reverse justify-between items-center w-[1600px] max-w-screen">
        ...
        <p
          id="header-nav-name"
          className="absolute w-full font-interText font-extrabold text-5xl min-[600px]:text-7xl min-[930px]:text-8xl min-[1210px]:text-9xl tracking-wide uppercase select-none text-white-bone text-left md:text-center "
        >
          Juan Urdaneta
        </p>
        <p
